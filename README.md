...
The myfempy is documented using the [Mkdocs](https://www.mkdocs.org/) under **docs** folder. The myfempy's web
documents can be found [here](https://myfempy.readthedocs.io/en/latest/).
