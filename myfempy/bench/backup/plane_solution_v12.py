...
file_geo = 'file_geo_braco_2d.geo'
name_out_mesh = 'file_geo_braco_2d.msh1'
...
#%% FORCAS E CARGAS 
node_search_force1 = search_nodeXY(100,6,coord,0.002)
...
frcApy_vet = np.array([[node_search_force1,2,-100]],dtype=object)

#%% CONDICOES DE CONTORNO

coordx=(coord[np.where(coord[:,1]<=12.0),:])[0]

node_search_bc1 = search_nodeY(6.0,coordx,0.002)
...
file_save='shell12_viewmesh_png.png'
...
file_dir='meshview_shell12_vtk.vtk'
export_mesh(file_dir,type_elm,datamesh[1],datamesh[2],meshDef,conec,stress_eqv_VM)
# Visualizar a malha VTK
file_save='meshview_shell12_png.png'
