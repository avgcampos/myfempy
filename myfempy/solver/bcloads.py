...
ESTE MODULO DEFINE AS CONDICOES DE CONTORNO DO PROBLEMA FISICO PROPOSTO
- ENTRADAS: datamesh, forcenodeaply, boncdnodeaply
- SAIDA: freedof, fixedof, vetF, node_search    
===============================================================================

> ATUALIZACOES DA VERSAO:

--- [bond_condi_phys]: Condicoes de contorno para elementos com 2 gdl por no e 3 gdl por no

--- [bond_condi_phys]: Geracao de gld para list force e list freedof intependente do gld por no,
calculo mais automatizado
_______________________________________________________________________________
"""
import numpy as np
import sys
...
def bcloads_apply(usrlog,datamesh,coord,inci,forcelistfull,boncdlist,tabgeo):
