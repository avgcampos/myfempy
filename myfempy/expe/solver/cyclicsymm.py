...
class CyclicSymmStaticLin(Solver):

    """
    Cyclic Symmetry Static Linear Solver Class <ConcreteClassService>
    """
    ...
    def runSolve(assembly, constrainsdof, modelinfo, solverset):
        ...
        # print(np.array2string(RM_left.todense(), separator=', ', precision=1))

        # plt.figure(1)
        # plt.spy(RM_left.todense(), markersize=4)
        # plt.show()

        # plt.figure(2)
        # plt.spy(RM_right.todense(), markersize=4)
        # plt.show()
