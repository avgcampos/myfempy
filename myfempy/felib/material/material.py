...
def getMaterial(set_material):
    if set_material['mat'] == 'axial':
        ...
        if set_material['type'] == 'isotropic':
            from myfempy.felib.material.planestress import PlaneStressIsotropic
        ...
        if set_material['type'] == 'isotropic':
            from myfempy.felib.material.planestrain import PlaneStrainIsotropic
        ...
        if set_material['type'] == 'isotropic':
            from myfempy.felib.material.solid import SolidIsotropic
