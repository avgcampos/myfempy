...
class Solid81:
    ...
    def lockey(self, nodelist):
        ...
        loc = np.array([self.nodedof*noi-3,self.nodedof*noi-2,self.nodedof*noi-1,\
                        ...
                        self.nodedof*nom-3,self.nodedof*nom-2,self.nodedof*nom-1,\
                        self.nodedof*non-3,self.nodedof*non-2,self.nodedof*non-1,\
                        self.nodedof*noo-3,self.nodedof*noo-2,self.nodedof*noo-1,\
    ...
    def stiff_linear(self, ee):
        ...
        for pp in range(0,self.npp):
            ...
            keh8 += np.dot(np.dot(np.transpose(B),D),B)*detJ*wp[pp]*wp[pp]*wp[pp]
            V += detJ
