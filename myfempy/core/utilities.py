...
_LINE_GAUSS = {
    1: (
        array([0.0], dtype=FLT64),
        array([2.0], dtype=FLT64),
    ),
    2: (
        array([-0.5773502691896258, 0.5773502691896258], dtype=FLT64),
        array([1.0, 1.0], dtype=FLT64),
    ),
    4: (
        array([-0.86113631, -0.33998104, 0.33998104, 0.86113631], dtype=FLT64),
        array([0.34785485, 0.65214515, 0.65214515, 0.34785485], dtype=FLT64),
    ),
    8: (
        array(
            [-0.96028986, -0.79666648, -0.52553241, -0.18343464,
              0.18343464,  0.52553241,  0.79666648,  0.96028986], dtype=FLT64),
        array(
            [0.10122854, 0.22238103, 0.31370665, 0.36268378,
             0.36268378, 0.31370665, 0.22238103, 0.10122854], dtype=FLT64),
    ),
}

_QUAD_GAUSS = {
    **_LINE_GAUSS,  # Reaproveita 1, 2, 4 e 8 pontos que são idênticos ao Line
    3: (
        array([-0.774596669241483, 0.0, 0.774596669241483], dtype=FLT64),
        array([0.555555555555556, 0.888888888888889, 0.555555555555556], dtype=FLT64),
    ),
    9: (
        array(
            [-0.96816024, -0.83603111, -0.61337143, -0.32425342, 0.0,
              0.32425342,  0.61337143,  0.83603111,  0.96816024], dtype=FLT64),
        array(
            [0.08127439, 0.18064816, 0.26061070, 0.31234708, 0.33023936,
             0.31234708, 0.26061070, 0.18064816, 0.08127439], dtype=FLT64),
    ),
}

_TRIA_GAUSS = {
    1: (
        array([0.3333333333333333], dtype=FLT64),
        array([1.0], dtype=FLT64),
    ),
    3: (
        array([0.6666666666666666, 0.1666666666666666, 0.1666666666666666], dtype=FLT64),
        array([0.3333333333333333, 0.3333333333333333, 0.3333333333333333], dtype=FLT64),
    ),
    7: (
        array(
            [0.1012865073235, 0.79742698553531, 0.1012865073235, 0.4701420641051,
             0.4701420641051, 0.59715871789800, 0.3333333333333], dtype=FLT64),
        array(
            [0.1259391805448, 0.1259391805448, 0.1259391805448, 0.1323941527885,
             0.1323941527885, 0.1323941527885, 0.2250000000000], dtype=FLT64),
    ),
}
...
_TETR_GAUSS = {
    1: (
        array([0.3333333333333333], dtype=FLT64),
        array([0.1666666666666667], dtype=FLT64),
    ),
    4: (
        array([0.5854101966249685, 0.1381966011250105, 0.1381966011250105, 0.1381966011250105], dtype=FLT64),
        array([0.25, 0.25, 0.25, 0.25], dtype=FLT64),
    ),
    5: (
        array([0.25, 0.50, 0.166666666666667, 0.166666666666667, 0.166666666666667], dtype=FLT64),
        array([-0.80, 0.45, 0.45, 0.45, 0.45], dtype=FLT64),
    ),
}
...
def gauss_points(type, npp):
    return _ELEMENT_GAUSS_MAP[type][npp]
