...
class UniAxialStressIsotropic(Material):
    ...
    def getElementStrain(Model, U, ptg, element_number):
        ...
        strain = [strn_elm_normal_tension, strn_elm_normal_bendingXY_max, strn_elm_normal_bendingXY_min, strn_elm_normal_bendingXZ_max, strn_elm_normal_bendingXZ_min, strn_elm_shear_torsion_max, 0.0]

        return epsilon, strain

    def getTitleStrain():
        title = ["STRAIN_NORMAL_TENSION", "STRAIN_NORMAL_BENDINGXY_MAX", "STRAIN_NORMAL_BENDINGXY_MIN", "STRAIN_NORMAL_BENDINGXZ_MAX", "STRAIN_NORMAL_BENDINGXZ_MIN", "STRAIN_SHEAR_TORSION", "null"]
        return title
    ...
    def getElementStress(Model, epsilon, element_number):        
        ...
        G = Model.tabmat[int(Model.inci[element_number, 2]) - 1]["GXX"] # material poisson ratio
        ...
        stress = [strs_elm_normal_tension, strs_elm_normal_bendingXY_max, strs_elm_normal_bendingXY_min, strs_elm_normal_bendingXZ_max, strs_elm_normal_bendingXZ_min, strs_elm_shear_torsion_max, 0.0]

        return sigma, stress

    def getTitleStress():
        title = ["STRESS_NORMAL_TENSION", "STRESS_NORMAL_BENDINGXY_MAX", "STRESS_NORMAL_BENDINGXY_MIN", "STRESS_NORMAL_BENDINGXZ_MAX", "STRESS_NORMAL_BENDINGXZ_MIN", "STRESS_SHEAR_TORSION", "null"]
        return title
