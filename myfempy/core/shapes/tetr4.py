...
class Tetra4(Shape):
    ...
    def getShapeSet():
        shapeset = {
            ...
            "id": 41,
            "nodes": ["i", "j", "k", "l"],
            "sidenorm": {"0": [0, 0, -1], "1": [0, -1, 0], "2": [-1, 0, 0], "3": [1, 1, 1]},
        }
        return shapeset
    ...
    def getAreaLength(J, side):
        #   J = [dx/dr  dy/dr   dz/dr]
        #       [dx/ds  dy/ds   dz/ds]
        #       [dx/dt  dy/dt   dz/dt]
        if side == "0":
            return 0.5*(J[0,0]*J[1,1] - J[1,0]*J[0,1])
        elif side == "1":
            return 0.5*(J[0,0]*J[2,2] - J[2,0]*J[0,2])
        elif side == "2":
            return 0.5*(J[1,1]*J[2,2] - J[2,1]*J[1,2])
        elif side == "3":
            return 0.5*(J[0,0]*J[1,1]*J[2,2] + J[0,1]*J[1,2]*J[2,0] + J[0,2]*J[1,0]*J[2,1] - J[2,0]*J[1,1]*J[0,2] - J[2,1]*J[1,2]*J[0,0] - J[2,2]*J[1,0]*J[0,1])
        else:
            return 0.0
