...
cdef inline np.ndarray[FLT64, ndim=2, mode="c"] MATN(FLT64 r0, FLT64 r1):
    ...
    N[0, 0] = 0.25 * (1.0 - r0) * (1.0 - r1) * (-r0 - r1 - 1.0)
    N[0, 1] = 0.25 * (1.0 + r0) * (1.0 - r1) * (r0 - r1 - 1.0)
    N[0, 2] = 0.25 * (1.0 + r0) * (1.0 + r1) * (r0 + r1 - 1.0)
    N[0, 3] = 0.25 * (1.0 - r0) * (1.0 + r1) * (-r0 + r1 - 1.0)
    N[0, 4] = 0.5 * (1.0 - r0 * r0) * (1.0 - r1)
    N[0, 5] = 0.5 * (1.0 + r0) * (1.0 - r1 * r1)
    N[0, 6] = 0.5 * (1.0 - r0 * r0) * (1.0 + r1)
    N[0, 7] = 0.5 * (1.0 - r0) * (1.0 - r1 * r1)
    return N
...
cdef inline np.ndarray[FLT64, ndim=2, mode="c"] MATDIFFN(FLT64 r0, FLT64 r1):
    cdef np.ndarray[FLT64, ndim=2, mode="c"] dN = np.zeros((2, 8), dtype=np.float64)
