...
@wraparound(False)         
@nonecheck(False)
cdef inline void MATN(FLT64 r0, FLT64 r1, FLT64 r2, FLT64 N[8]) noexcept nogil:
...
@wraparound(False)         
@nonecheck(False)
cdef inline void MATDIFFN(FLT64 r0, FLT64 r1, FLT64 r2, FLT64 dN[3][8]) noexcept nogil:
