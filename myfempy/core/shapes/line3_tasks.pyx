...
cdef inline np.ndarray[FLT64, ndim=2, mode="c"] MATN(FLT64 r0):
    cdef np.ndarray[FLT64, ndim=2, mode="c"] N = np.zeros((4, 18), dtype=np.float64)
    N[0, 0]  = 0.5 * (1.0 - r0) - 0.5 * (1.0 - r0 * r0)
    N[0, 6]  = 0.5 * (1.0 + r0) - 0.5 * (1.0 - r0 * r0)
    N[0, 12] = 1.0 - r0 * r0
    N[1, 1]  = 0.25 * (3.0 * r0**5 - 2.0 * r0**4 - 5.0 * r0**3 + 4.0 * r0**2)
    N[1, 5]  = 0.25 * (0.5 * r0**5 - 0.5 * r0**4 - 0.5 * r0**3 + 0.5 * r0**2)
    N[1, 7]  = 0.25 * (-3.0 * r0**5 - 2.0 * r0**4 + 5.0 * r0**3 + 4.0 * r0**2)
    N[1, 11] = 0.25 * (0.5 * r0**5 + 0.5 * r0**4 - 0.5 * r0**3 - 0.5 * r0**2)
    N[1, 13] = 0.25 * (4.0 * r0**4 - 8.0 * r0**2 + 4.0)
    N[1, 17] = 0.25 * (2.0 * r0**5 - 4.0 * r0**3 + 2.0 * r0)
    N[2, 2]  = 0.25 * (3.0 * r0**5 - 2.0 * r0**4 - 5.0 * r0**3 + 4.0 * r0**2)
    N[2, 4]  = 0.25 * (0.5 * r0**5 - 0.5 * r0**4 - 0.5 * r0**3 + 0.5 * r0**2)
    N[2, 8]  = 0.25 * (-3.0 * r0**5 - 2.0 * r0**4 + 5.0 * r0**3 + 4.0 * r0**2)
    N[2, 10] = 0.25 * (0.5 * r0**5 + 0.5 * r0**4 - 0.5 * r0**3 - 0.5 * r0**2)
    N[2, 14] = 0.25 * (4.0 * r0**4 - 8.0 * r0**2 + 4.0)
    N[2, 16] = 0.25 * (2.0 * r0**5 - 4.0 * r0**3 + 2.0 * r0)
    N[3, 3]  = 0.5 * (1.0 - r0) - 0.5 * (1.0 - r0 * r0)
    N[3, 9]  = 0.5 * (1.0 + r0) - 0.5 * (1.0 - r0 * r0)
    N[3, 15] = 1.0 - r0 * r0
    return N
...
cdef inline np.ndarray[FLT64, ndim=2, mode="c"] MATDIFFN(FLT64 r0):
    cdef np.ndarray[FLT64, ndim=2, mode="c"] dN = np.zeros((1, 9), dtype=np.float64)
    dN[0, 0] = -0.5 + r0
    dN[0, 3] = 0.5 + r0
    dN[0, 6] = -2.0 * r0
    return dN
...
cdef inline np.ndarray[FLT64, ndim=2, mode="c"] MATDIFFDIFFN(FLT64 r0):
    cdef np.ndarray[FLT64, ndim=2, mode="c"] ddN = np.zeros((4, 18), dtype=np.float64)
    ddN[0, 0]  = r0
    ddN[0, 6]  = r0
    ddN[0, 12] = -2.0
    ddN[1, 1]  = 0.25 * (60.0 * r0**3 - 24.0 * r0**2 - 30.0 * r0 + 8.0)
    ddN[1, 5]  = 0.25 * (10.0 * r0**3 - 6.0 * r0**2 - 3.0 * r0 + 1.0)
    ddN[1, 7]  = 0.25 * (-60.0 * r0**3 - 24.0 * r0**2 + 30.0 * r0 + 8.0)
    ddN[1, 11] = 0.25 * (10.0 * r0**3 + 6.0 * r0**2 - 3.0 * r0 - 1.0)
    ddN[1, 13] = 0.25 * (48.0 * r0**2 - 16.0)
    ddN[1, 17] = 0.25 * (40.0 * r0**3 - 24.0 * r0)
    ddN[2, 2]  = 0.25 * (60.0 * r0**3 - 24.0 * r0**2 - 30.0 * r0 + 8.0)
    ddN[2, 4]  = 0.25 * (10.0 * r0**3 - 6.0 * r0**2 - 3.0 * r0 + 1.0)
    ddN[2, 8]  = 0.25 * (-60.0 * r0**3 - 24.0 * r0**2 + 30.0 * r0 + 8.0)
    ddN[2, 10] = 0.25 * (10.0 * r0**3 + 6.0 * r0**2 - 3.0 * r0 - 1.0)
    ddN[2, 14] = 0.25 * (48.0 * r0**2 - 16.0)
    ddN[2, 16] = 0.25 * (40.0 * r0**3 - 24.0 * r0)
    ddN[3, 3]  = r0
    ddN[3, 9]  = r0
    ddN[3, 15] = -2.0
    return ddN
...
cdef inline np.ndarray[FLT64, ndim=2, mode="c"] JACOBIANO(FLT64 r0, FLT64 [:, ::1] element_coord):  
    ...
    jac[0, 0] = (diffN[0, 0] * element_coord[0, 0] + 
                 ...
                 diffN[0, 6] * element_coord[6, 0] + 
                 diffN[0, 7] * element_coord[7, 0] + 
                 diffN[0, 8] * element_coord[8, 0])
    return jac
...
def ShapeFunctions(FLT64 [::1] r_coord, INT32 nodedof, FLT64 detJ):
    ...
    mat_N[1, 17] = 2.0 * detJ * mat_N[1, 17]
    mat_N[2, 4]  = 2.0 * detJ * mat_N[2, 4] 
    mat_N[2, 10] = 2.0 * detJ * mat_N[2, 10] 
    mat_N[2, 16] = 2.0 * detJ * mat_N[2, 16] 
    return mat_N
...
def DiffDiffShapeFuntion(FLT64 [::1] r_coord, INT32 nodedof, FLT64 detJ):
    ...
    mat_diff_N[1, 17] = 2.0 * detJ * mat_diff_N[1, 17] 
    mat_diff_N[2, 4]  = 2.0 * detJ * mat_diff_N[2, 4] 
    mat_diff_N[2, 10] = 2.0 * detJ * mat_diff_N[2, 10] 
    mat_diff_N[2, 16] = 2.0 * detJ * mat_diff_N[2, 16] 
    return mat_diff_N
...
def NodeList(INT32 [:, ::1] inci, INT32 element_number):
    cdef np.ndarray[INT32, ndim=1, mode="c"] node_list = np.zeros(3, dtype=np.int32)
...
def NodeCoord(FLT64 [:, ::1] coord, INT32 [::1] node_list):
    cdef np.ndarray[FLT64, ndim=2, mode="c"] element_coord = np.zeros((9, 1), dtype=np.float64)
    ...
    element_coord[6, 0] = coord[node_list[2] - 1, 1]
    element_coord[7, 0] = coord[node_list[2] - 1, 2]
    element_coord[8, 0] = coord[node_list[2] - 1, 3]
